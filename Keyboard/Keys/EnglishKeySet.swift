...
private let DT = DoubleKey(title: "D T", first: "D", second: "T")
private let KQ = DoubleKey(title: "K Q", first: "K", second: "Q")
...
private let SZ = DoubleKey(title: "S Z", first: "S", second: "Z")
...
private let PF = DoubleKey(title: "P F", first: "P", second: "F")
