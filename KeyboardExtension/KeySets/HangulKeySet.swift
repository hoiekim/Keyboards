...
private let ㅏ = HangulKey(firstUnicode: LETTER_ㅏ, secondUnicode: LETTER_ㅑ, backgroundColor: customGray4)
private let ㅐ = HangulKey(firstUnicode: LETTER_ㅐ, secondUnicode: LETTER_ㅒ, backgroundColor: customGray4)
private let ㅓ = HangulKey(firstUnicode: LETTER_ㅓ, secondUnicode: LETTER_ㅕ, backgroundColor: customGray4)
private let ㅔ = HangulKey(firstUnicode: LETTER_ㅔ, secondUnicode: LETTER_ㅖ, backgroundColor: customGray4)
private let ㅗ = HangulKey(firstUnicode: LETTER_ㅗ, secondUnicode: LETTER_ㅛ, backgroundColor: customGray4)
private let ㅜ = HangulKey(firstUnicode: LETTER_ㅜ, secondUnicode: LETTER_ㅠ, backgroundColor: customGray4)
private let ㅡ = HangulKey(firstUnicode: LETTER_ㅡ, backgroundColor: customGray4)
private let ㅣ = HangulKey(firstUnicode: LETTER_ㅣ, backgroundColor: customGray4)
